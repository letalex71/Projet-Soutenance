...
class __TwigTemplate_961dce33bf2a9785771d1c9a3784b09e89831c366edd64e72d5b6a495cfa76d5 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"POST\" class=\"col-6 offset-3\">
    ...
    ";
        // line 38
        echo "    <button class=\"btn btn-sm btn-primary mt-2\" type=\"submit\">
        Connexion
    </button>
</form>
</div>
...
<form method=\"POST\" class=\"col-6 offset-3\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes connectés en tant que {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Deconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\Alex\\Documents\\DEV\\movilist\\templates\\security\\login.html.twig");
    }
}
